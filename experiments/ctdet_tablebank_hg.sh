...
# first epoch
#python main.py ctdet --dataset tablebank --exp_id tablebank_hg --arch hourglass --batch_size 10 --master_batch 4 --lr 2.5e-4 --load_model ../models/ctdet_coco_hg.pth --gpus 1 --num_epochs 1 --lr_step 5,10,15
